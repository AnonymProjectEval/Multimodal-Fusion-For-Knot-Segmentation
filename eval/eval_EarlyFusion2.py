...
CSV_PATH = str(Path(MODEL_PATH).resolve().parent / "test_metrics_dice_hd95_blob800_earlyfusion2.csv")
...
from EarlyFusion2.train_unet import EarlyFusion2LinearMixUNet
