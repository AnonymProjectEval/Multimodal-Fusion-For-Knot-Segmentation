...
try:
    ...
    raise ImportError(
        "This script needs SciPy for connected component blob removal. Install it with pip install scipy."
    ) from e
...
# Update this to your IntermediateFusion2 best checkpoint
MODEL_PATH = (
...
CSV_PATH = str(Path(MODEL_PATH).resolve().parent / "test_metrics_dice_hd95_blob800_intermediate2.csv")
...
from IntermediateFusion2.train_unet_concat import IntermediateConcatFusionUNet
            ...
            rows.append(
                {
                    ...
                    "feature_channels": str(FEATURE_CHANNELS),
                    "fusion_dropout": FUSION_DROPOUT,
                    "init_gamma": INIT_GAMMA,
                }
            )
