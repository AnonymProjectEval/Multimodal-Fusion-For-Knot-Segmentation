...
CSV_PATH = str(Path(MODEL_PATH).resolve().parent / "test_metrics_dice_hd95_blob800.csv")

# Match your training crop size
...
from EarlyFusion.train_unet import build_nnunet_direct
